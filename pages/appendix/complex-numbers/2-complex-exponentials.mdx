...
Ein rigoroser Beweis soll jedoch erspart bleiben. Genau dieser Wert wurde letztendlich als die **eulersche Zahl** $e \approx 2.718$ definiert. Somit lässt scih obiger Term umschreiben und von $B(x)$ zu dem üblichen $\exp (x)$ umbenennen:
