...
Um zu verstehen, was sich beim Potenzieren der komplexen Zahl $z = \lim_{n\to\infty} (1+\frac{\theta i}{n})$ ergibt, ist es sinnvoll, wie im vorherigen Abschnitt herausgestellt wurde, die Polardarstellung zu ermitteln.
...
Im Gegensatz zum ersten Abschnitt auf dieser Seite, ist diese Argumentation kein _richtiger_ Beweis. Jedoch sollte damit die **Eulersche Formel** plausibel erscheinen.
