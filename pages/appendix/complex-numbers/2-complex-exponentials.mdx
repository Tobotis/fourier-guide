...
Der Betrag wird durch das Potenzieren mit $n$, ebenfalls $n$ potenziert, der Polarwinkel jedoch mit $n$ multipliziert (dies wurde in [_Komplexe Ebene_](./1-complex-plane#folgerungen)).
