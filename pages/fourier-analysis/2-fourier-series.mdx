...
<Callout type="info" emoji="📚">
  ...
  [Wikipedia:
  Dirichlet-Bedingung](https://de.wikipedia.org/wiki/Dirichlet-Bedingung)
  ...
  ist. Die *Eigenschaften* beinhalten jedoch z.B., dass das Integral der
...
Aus dieser Berechnung der Koeffizienten wird deutlich, dass die Funktion $f(t)$ **integrierbar** sein muss.

Diese Problematik ließe sich noch deutlich weiter analysireren. Man kann sich ausgibig Gedanken über die **Konvergenz** der **Fourier-Reihe** Gedanken machen. In diesem Abschnitt sollte jedoch lediglich geklärt werden, woher die **Fourier-Reihe** kommt, und wie man sie möglicherweise anwenden kann.
...
somit würde sich das _periodische_ Phänomen (bzw. nicht-periodische Phänomen) in _unendlicher_ Zeit nur ein einmal wiederholen.
