...
Im Folgenden sind einige Beispiele für Annäherungen durch **Fourier-Reihen** dargestellt. Die Koeffizientenbestimmung erfolgt wie hergeleitet, durch das Integrieren der gegeben Funktion $f(t)$
