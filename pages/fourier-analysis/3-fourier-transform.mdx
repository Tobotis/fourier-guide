...
<QuestionAnswer>
  <>Welche Eigenschaft ist bei obiger **Fourier-Reihe** erfüllt?</>
  <Answer correct={true}>Für $c_k$ mit $k<0$ gilt $c_k = \overline{c}_{-k}$</Answer>
...
Dadurch, dass 
$$
|\int_{-\infty}^{\infty} f(t) e^{\frac{-2 \pi i k}{T}t} dt | < \int_{-\infty}^{\infty} |f(t)| dt < \infty
$$
gilt ([**Dirichlet-Bedingung**](https://en.wikipedia.org/wiki/Dirichlet%E2%80%93Jordan_test)), würde $c_k$ aufgrund von $\frac{1}{T}$ gegen $0$ gehen, wenn $T \to \infty$. Auf diese Bedingung wurde bereits in [*Fourier-Reihen*](./2-fourier-series#unendliche-anzahl-von-termen) hingewiesen.
</Callout>
