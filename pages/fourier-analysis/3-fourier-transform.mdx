...
Das Verständis dieses **inversen** Zusammenhangs wird in Bezug auf eine _unendliche_ Periodendauer relevant: Je länger die länger die Periodendauer und somit _breiter_ der Zeitraum, desto _enger_ wird das Frequenzspektrum.
...
für $T\to \infty$ zu verallgemeinern um das Ganze auch auf nicht-periodische Funktionen anzuwenden.
